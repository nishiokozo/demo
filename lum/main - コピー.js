...
//-----------------------------------------------------------------------------
function print( tx, ty, str, size=16, align="left" )
//-----------------------------------------------------------------------------
{
	g_context.font = size.toString() + "px monospace";
	g_context.fillStyle = "#000000";
	g_context.textAlign = align;
...
function test1()
{
	print( 10,10+(g_line+=20), "ボタン押し下げ" );
	console.log("test1"); //test1と表示される
    let write_json=JSON.stringify(g_tblVect);
