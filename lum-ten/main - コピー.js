/*1380*/ 160,370,7,180,370,7,310,280,7,270,265,7,255,255,7,221,239,7,125,220,7,145,187,7,255,203,7,80,360,9,100,340,9,110,345,9,113,350,9,98,360,4,105,357,4,109,357,4,98,360,10,105,357,10,109,357,10,108,83,11,185,205,11,172,221,11,
/*1390*/ 191,192,11,200,250,12,238,267,12,350,100,13,167,51,13,301,115,13,304,117,13,310,119,13,467,185,13,169,51,13,304.5,117,13,468,185,13,500,50,14,290,20,14,0,30,14,-20,190,14,40,245,14,210,360,14,275,377,14,500,350,14,340,13,14,50,
/*1400*/ 249,14,201,345,14,254,362,14,430,356,14,999,999,
/*1410*/ //仕上げ
...
//-----------------------------------------------------------------------------
{
	...
	while( i < data.length )
	{
		...
		case 2: // ex ey , line
			...
			if ( ex == 999 && md == 0 )	{stat = 0;md=1;continue;}	// end segment & pset mode
			if ( ex == 999 && md == 1 )	{stat = 2;md=2;continue;}	// end segment & paint mode
			if ( ex == 999 && md == 2 )	{stat = 0;md=3;continue;}	// end segment & シアゲ line
			if ( ex == 999 && md == 3 )	{stat = 9;    ;continue;}	// end segment & シアゲ line
			if ( ex == 666 )								// end segment & ten eyes
			{
				gra.circle(217,213,7.8,g_tblCol8[0],2,2.1 );	 
				gra.circle(244,231,7.8,g_tblCol8[0],2,2.1 );	 
				stat = 2;
				continue;
			}
			...
			if ( md == 2 )	//	paint
			{
				let g_tblPat = 
				{
					1:[ [[0xffff00]],	[0xff0000,0,0x00ff00] ],
					2:[ [[0xffff00]],	[0xff0000,0,0x00ff00] ],
				}
				...
				switch(c)
				{
					case  1:col = [[0x000000]];								rej = [0,0x00ff00,0xff0000,0xffffff];break;
					case  2:col = [[0x00ff00]];								rej = [0,0x00ff00,0xff0000,0xffffff];break;
					case  3:col = [[0x00ffff]];								rej = [0,0x00ff00,0xff0000,0xffffff];break;
					case  4:col = [[0xffffff]];								rej = [0,0x00ff00,0xff0000,0xffffff];break;
					case  5:col = [[0x00ff00,0x000000],[0x000000,0x00ff00]];rej = [0,0x00ff00,0xff0000,0xffffff];break;
					case  6:col = [[0xffffff,0xffff00],[0xffff00,0xffffff]];rej = [0,0x00ff00,0xff0000,0xffffff];break;
					case  7:col = [ [0xffffff,0xff0000,0xffff00,0xff0000],
									[0xff0000,0xffff00,0xff00ff,0xffff00]] ;rej = [0,0x00ff00,0xff0000,0xffffff];break;
					case  8:col = [[0x000000,0x0000ff],[0x0000ff,0x000000]]; rej = [0,0x00ff00,0xff0000,0xffffff];break;
					case  9:col = [[0x0000ff,0x00ffff],[0x00ffff,0x0000ff]]; rej = [0,0x00ff00,0xff0000,0xffffff];break;
					case 10:col = [[0xff00ff,0x00ffff],[0x00ffff,0xff00ff]]; rej = [0,0x00ff00,0xff0000,0xffffff];break;
/*テントラムの間*/	case 11:col = [[0xffff00,0xff0000],[0xff0000,0xffff00]]; rej = [0,0x00ff00,0xff0000,0xffffff];break;
/*テンの口の中*/	case 12:col = [[0x000000,0x00ff00],[0x00ff00,0x000000]]; rej = [0,0x00ff00,0xff0000,0xffffff];break;
/*雲暗*/			case 13:col = [[0xffffff,0x00ffff],[0x00ffff,0xffffff]]; rej = [0,0x00ff00,0xff0000,0xffffff];break;
					case 14:col = [[0x00ffff,0x0000ff],[0x0000ff,0x00ffff]]; rej = [0,0x00ff00,0xff0000,0xffffff];break;
				}
				if (1) gra.paint( ex,ey, col,rej );
				else   {gra.circle(ex,ey, 5,0xff0000,2,2);gra.paint( ex,ey, col,[0xff0000] );}
...
let g_sh = 1;
//-----------------------------------------------------------------------------
gra.window = function( x0,y0,x1,y1, x2,y2,x3,y3 )
//-----------------------------------------------------------------------------
{
	g_x0 = x0;
	g_y0 = y0;
...
//-----------------------------------------------------------------------------
gra.window_conv = function( _ox, _oy )
//-----------------------------------------------------------------------------
{
...
//-----------------------------------------------------------------------------
gra.pset0 = function( _ox, _oy, col )
//-----------------------------------------------------------------------------
{
...
//-----------------------------------------------------------------------------
gra.pset = function( _px, _py, col )
//-----------------------------------------------------------------------------
{
	let [px,py] = gra.window_conv( _px, _py );
	gra.pset0( px, py, col );
}

//-----------------------------------------------------------------------------
gra.line = function( _x1, _y1, _x2, _y2, col ) 
//-----------------------------------------------------------------------------
{
	let [x1,y1] = gra.window_conv( _x1, _y1 );
	let [x2,y2] = gra.window_conv( _x2, _y2 );
...
//-----------------------------------------------------------------------------
gra.box = function( x1,y1, x2,y2, col )
//-----------------------------------------------------------------------------
{

	gra.line( x1,y1,x2,y1, col);
	gra.line( x1,y2,x2,y2, col);
	gra.line( x1,y1,x1,y2, col);
	gra.line( x2,y1,x2,y2, col);
}
...
//-----------------------------------------------------------------------------
{
	// 再起呼び出し型Paint タイルペイントや境界色判定はないがアルゴリズムの参考に残してある
...
//-----------------------------------------------------------------------------
gra.paint = function(  _x0, _y0, colsPat, colsRej  ) 
//-----------------------------------------------------------------------------
{
//	呼び出しサンプル
...
//	gra.paint( 100,100, [[0xffff00]],[0xff0000] );
	...
	let [x0,y0] = gra.window_conv( _x0, _y0 );
...
//	gra.circle(245,195,143,g_tblCol8[7],2,1.3 );//画面いっぱいに円
//	gra.box(-39,10,529,379, g_tblCol8[2]);	//画面いっぱいに箱


///*1320*/ 370,200,2,155,100,2,230,142,2,210,160,2,0,200,2,50,220,2,50,240,2,130,283,2,180,325,2,235,350,2,260,285,2,250,190,2,185,215,2,177,25,2,260,278,2,263,

//	gra.circle(100,100,10,0xffffff);
	let [x,y]=[370,200];
//	gra.paint(x,y,[[0x00ff00]],[0,0x00ff00]);
//	gra.circle(x,y, 5,0xff0000,2,2);

//	gra.paint( 370,200, [[0xffff00]],[0xff0000,0,0x00ff00] );
